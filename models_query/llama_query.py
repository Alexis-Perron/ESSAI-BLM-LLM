...
# -------------------------
# Public result container (same contract as gpt_query.py / gemma_query.py / qwen_query.py)
# -------------------------
@dataclass
...
class LlamaQuery:
    ...
    Same method signature as GPTQuery / GemmaQuery / QwenQuery:
      sample_expected_return(system_prompt, user_prompt, n_samples, temperature) -> LLMReturnResult

    By default, this targets llama3.2 (Ollama library id). You can pass any Ollama model id.
    """
...
# Backward-compatible alias (some drafts used this name in run.py)
Llama_Query = LlamaQuery
