...
# -------------------------
# Public result container (same contract as gpt_query.py / gemma_query.py)
# -------------------------
@dataclass
...
class QwenQuery:
    ...
    Same method signature as GPTQuery / GemmaQuery:
      sample_expected_return(system_prompt, user_prompt, n_samples, temperature) -> LLMReturnResult

    By default, this targets qwen2.5:1.5b, but you can pass any Ollama model id.
    """
