...
for month in months:
    ...
    # check if the required files exist, else skip
    if (os.path.exists(f'yfinance/returns_{train_start}_{train_end}.csv') and os.path.exists(f'yfinance/returns_{test_start}_{test_end}.csv')):
